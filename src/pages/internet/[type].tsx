...
const InternetType = ({ allProviders }: any) => {
     ...
     console.log("🚀 ~ file: [type].tsx:14 ~ InternetType ~ t:", t)
     ...
     return (
          <section className='container mx-auto px-3 my-20'>
               ...
               <ProviderDesign tProvider={t} icon={<CiStar />} title="Highest speed stability" />
               <p className='mt-7 text-lg text-gray-600'>{t?.title} internet plans offer services in all 50 states and offer fiber speeds up to {t?.providersInfo?.servicesInfo?.internetServices?.summarySpeed} Mpbs. Internet plans are designed to provide the right products you need for your lifestyle at competitive prices.</p>
               <h2 className="sm:text-3xl mt-10 mb-7 text-2xl font-bold capitalize leading-10" >Fiber Internet Compared to Other Connection Types</h2>
