...
const Header = () => {
    ...
    return (
        <header className="h-auto shadow-sm py-2 max-h-[80px]">
            <nav className="container mx-auto px-4 flex items-center justify-between ">
                ...
                <div className={`sm:w-2/3 w-full sm:justify-center sm:static absolute left-0 sm:py-0 py-7 sm:px-0 px-5 flex items-center ${open ? 'top-[107px] bg-white z-40' : 'top-[-100%] '}`}>
                    <ul className="flex sm:flex-row flex-col sm:items-center md:gap-[3vw] gap-5">
                        ...
                        <li onMouseEnter={() => handleSubMenu(1)} onMouseLeave={() => setSubMenu(null)} className='flex relative items-center gap-2 cursor-pointer group'>
                            ...
                            <div className={`${subMenu === 1 ? 'block md:grid' : 'hidden'} pt-12`}>
                                <div id="1" className={`bg-white md:absolute static md:w-[650px] w-full left-0 md:py-8 pt-5  pb-0 md:px-8 px-0 grid gap-5 z-50 md:shadow-[0_0_5px_3px_rgba(0,0,0,0.1)] md:grid-cols-3 `} >
                        ...
                        <li onMouseEnter={() => handleSubMenu(2)} onMouseLeave={() => setSubMenu(null)} className='flex relative items-center gap-2 cursor-pointer group'>
                            <Link href="#" className='text-sm font-bold tracking-normal text-[#4d4c4f] hover:text-[#FECE2F] AxiformaRegular'>Providers</Link>
                            <span>
                                <FaChevronDown className="text-[#4d4c4f] group-hover:text-[#FECE2F]" />
                            </span>
                            <div className={`${subMenu === 2 ? 'block md:grid' : 'hidden'} pt-12 `}>
                                <div id="2" className={`bg-white md:absolute static left-0 md:w-[650px] w-full md:py-8 pt-5 pb-0 md:px-8 px-0 grid gap-5 z-50 md:shadow-[0_0_5px_3px_rgba(0,0,0,0.1)] md:grid-cols-3 `} >
                                    <div className='col-span-2' >
                        ...
                        <li onMouseEnter={() => handleSubMenu(3)} onMouseLeave={() => setSubMenu(null)} className='flex relative items-center gap-2 cursor-pointer group'>
                            ...
                            <div className={`bg-white md:absolute static left-0 md:w-[650px] w-full md:py-8 pt-5 pb-0 md:px-8 px-0 grid gap-5 z-50 md:shadow-[0_0_5px_3px_rgba(0,0,0,0.1)] md:grid-cols-3  `} >
                                <div className='col-span-2' >
                                    <h2>TOP STATES</h2>
                                    <ul className='grid md:grid-cols-2'>
                                        <li>
                        ...
                        <li onMouseEnter={() => handleSubMenu(4)} onMouseLeave={() => setSubMenu(null)} className='flex relative items-center gap-2 cursor-pointer group'>
