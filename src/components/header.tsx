...
//       ]);
//       const providersServicesType =
//         providersServicesTypeRes?.data?.serviceTypes?.nodes;
  ...
  return (
    <header className="h-auto shadow-sm py-2 !relative">
      <nav className="container mx-auto px-4 flex items-center justify-between ">
        ...
        <div
          className={`flex absolute md:relative items-center ${
            open
              ? "top-[43.5px] left-0 shadow-lg right-0 p-6 w-full !bg-white z-40"
              : "top-[-400%]"
          }`}
        >
          <ul className="flex md:flex-row flex-col sm:items-center md:gap-[3vw] gap-5">
            ...
            >
              <div className="flex items-center md:py-4">
                <Link
                  href="#"
                  className="text-sm font-bold tracking-normal text-[#4d4c4f] hover:text-[#FECE2F] AxiformaRegular"
                >
                  Internet & TV
                </Link>
                <span className="ml-1">
              ...
              <div
                className={`${
                  subMenu === 1 ? "block md:grid" : "hidden"
                } mt-4 md:mt-0`}
              >
                <div
                  id="1"
                  className={`bg-white md:absolute transform md:-translate-x-1/2 md:left-1/2 relative md:w-[650px] w-full md:py-8 md:pt-5  pb-0 md:px-8 px-0 grid gap-5 z-50 md:shadow-[0_0_5px_3px_rgba(0,0,0,0.1)] grid-cols-2 md:grid-cols-3 `}
                >
                  <div className="col-span-2">
                    <h2 className="uppercase border-b-2 bottom-1">
                      Services Type
                    </h2>
            ...
            >
              ...
              <div
                className={`${
                  subMenu === 2 ? "block md:grid" : "hidden"
                } mt-4 md:mt-0`}
              >
                <div
                  id="1"
                  className={`bg-white md:absolute transform md:-translate-x-1/2 md:left-1/2 relative md:w-[650px] w-full md:py-8 md:pt-5  pb-0 md:px-8 px-0 grid gap-5 z-50 md:shadow-[0_0_5px_3px_rgba(0,0,0,0.1)] grid-cols-2 md:grid-cols-2 `}
                >
                  <div className="col-span-2">
                    <h2 className="font-bold  border-b-2 mb-2 pb-2">
                      Top Providers
                    </h2>
            ...
            >
              ...
              <div
                className={`${
                  subMenu === 3 ? "block md:grid" : "hidden"
                } mt-4 md:mt-0`}
              >
                <div
                  id="1"
                  className={`bg-white md:absolute transform md:-translate-x-1/2 md:left-1/2 relative md:w-[650px] w-full md:py-8 md:pt-5  pb-0 md:px-8 px-0 grid gap-5 z-50 md:shadow-[0_0_5px_3px_rgba(0,0,0,0.1)] grid-cols-2 md:grid-cols-4 `}
                >
                  <div className="col-span-2">
                    <h2 className="uppercase border-b-2 bottom-1 pb-2 mb-2">
                      TOP STATES
                    </h2>
            ...
            >
              ...
              <div
                className={`${
                  subMenu === 4 ? "block md:grid" : "hidden"
                } mt-4 md:mt-0`}
              >
                <div
                  id="1"
        ...
        <div className=" lg:block hidden">
          <Link
            href="/contact-us"
            className="text-sm whitespace-nowrap font-bold tracking-normal AxiformaRegular bg-[#FECE2F] text-[#4B4B4B] py-3 px-12 rounded-[3px] flex w-fit ml-auto"
          >
            Contact Us
          </Link>
