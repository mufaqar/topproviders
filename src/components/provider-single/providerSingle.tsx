...
export default function ProviderSingle({ ProviderRes }: any) {

  const [Provider, setProvider] = useState<any>(ProviderRes);
  ...
  return (
    <>
      ...
      <section className='relative bg-[#FECE2F]'>
        <div className="container mx-auto px-4 flex md:flex-row flex-col gap-7 items-center">
          <div className='md:w-1/2 w-full py-10'>
            <h1 className="text-3xl md:text-5xl md:leading-tight font-bold text-black">
              <span className='text-[#6041BB]'>{provider_name} </span>Plans and Pricing for {currentMonthName}, {currentYear}
            </h1>
      ...
      <section className="my-16">
        <div className="container mx-auto px-4">
          <div className='mb-10'>
            <h2 className="text-2xl font-bold">
              Make the switch to {provider_name}  and experience the advantages you'll truly enjoy!
            </h2>
          </div>
