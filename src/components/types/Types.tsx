...
import ProvidersCompare from "../compare/providers-compare";
import ProviderDesign from "../ProviderDesign";
import { CiStar } from "react-icons/ci";
import CompareConectionTypes from "../compareConectionTypes";

const Types = ({ providerType, service }: any) => {
    ...
    <>
      ...
      <h1
        className={`sm:text-5xl text-white text-2xl container mx-auto px-3 ${
          isSticky ? "py-6" : "py-20"
        } font-bold capitalize leading-10 transition-all duration-200`}
      >
        Best {providerType} Providers{" "}
      ...
      <section className="container mx-auto px-3 my-20">
        ...
        <p className="mt-3">
          {type} internet transfers data through glass, fiber-optic cables,
          which makes it capable of moving information at the speed of light.{" "}
          {type}
          ...
          availability compared to DSL and cable internet, but providers
          continue to invest in {type} internet.
        </p>
        <h2 className="sm:text-3xl mt-10 text-2xl font-bold capitalize leading-10">
        ...
        <div className="mt-12 bg-gray-100 p-12 rounded-2xl">
          ...
          <p className=" text-lg text-gray-600">
            ...
            can feel overwhelming. To help with your search, our team of
            internet experts evaluates ISPs on categories including performance,
            affordability, and customer satisfaction to provide you with the
