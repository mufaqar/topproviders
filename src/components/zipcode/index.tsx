    ...
    return (
        <>
            ...
            <PageHead
                ...
                url={`https://topproviders.net/${type}/zip-${zipcode}`} curl={`https://topproviders.net/${type}/zip-${zipcode}`}
            />
            <section className="min-h-[40vh]  flex items-center bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className='flex justify-center flex-col items-center'>
                        ...
                        <button className="text-[#ef9831] border hover:bg-[#ef9831] hover:text-white border-[#ef9831] p-3 px-8 rounded-lg" onClick={handleModelBox}>Change Zipcode</button>
                    </div>
                </div>
            </section>
